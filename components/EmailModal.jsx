...
const EmailModal = ({ isOpen, onClose, isDark, emailContent, onSendEmail }) => {
  ...
  if (showConfirmation) {
    return (
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center px-4 py-4 z-50 overflow-y-auto">
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 overflow-y-auto">
      <div className="min-h-full flex items-center justify-center px-4 py-8">
        <div
          className={cn(
            'rounded-lg p-6 w-full sm:max-w-md md:max-w-2xl shadow-xl transform transition-all',
            'bg-card text-card-foreground',
            'relative my-auto'
          )}
        >
